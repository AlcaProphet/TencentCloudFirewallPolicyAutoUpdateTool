...
[您可以在OpenAPI Explorer中直接运行该接口，免去您计算签名的困扰。运行成功后，OpenAPI Explorer可以自动生成SDK代码示例。](https://api.aliyun.com/api/SWAS-OPEN/2020-06-01/DeleteFirewallRules)

 [![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png) 调试](https://api.aliyun.com/api/SWAS-OPEN/2020-06-01/DeleteFirewallRules)
...
| --- | --- | --- | --- | --- |
| swas-open:DeleteFirewallRules | delete | \\*Instance `acs:swas-open:{#regionId}:{#accountId}:instance/{#InstanceId}` | 无   | 无   |

## 请求参数

| **名称** | **类型** | **必填** | **描述** | **示例值** |
| --- | --- | --- | --- | --- |
| InstanceId | string | 是   | 轻量应用服务器实例 ID。 | 2ad1ae67295445f598017499dc\\*\\*\\*\\* |
...
| RuleIds | array | 否   | 要删除的防火墙规则 ID 的列表。 |     |
|     | string | 否   | 防火墙规则 ID | eeea34d9867b4d55a4ff8d5fcfbd\\*\\*\\*\\* |
...
更多信息，参考[变更详情](https://api.aliyun.com/document/SWAS-OPEN/2020-06-01/DeleteFirewallRules#workbench-doc-change-demo)。