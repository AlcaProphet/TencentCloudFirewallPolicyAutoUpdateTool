...
[您可以在OpenAPI Explorer中直接运行该接口，免去您计算签名的困扰。运行成功后，OpenAPI Explorer可以自动生成SDK代码示例。](https://api.aliyun.com/api/SWAS-OPEN/2020-06-01/EnableFirewallRule)

 [![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png) 调试](https://api.aliyun.com/api/SWAS-OPEN/2020-06-01/EnableFirewallRule)
...
| --- | --- | --- | --- | --- |
| swas-open:EnableFirewallRule | update | \\*FirewallRule `acs:swas-open:{#regionId}:{#accountId}:firewallrule/{#RuleId}` | 无   | 无   |

## 请求参数

| **名称** | **类型** | **必填** | **描述** | **示例值** |
| --- | --- | --- | --- | --- |
| InstanceId | string | 是   | 指定的轻量应用服务器的实例 ID。 | 2ad1ae67295445f598017499dc\\*\\*\\*\\* |
...
| --- | --- | --- | --- |
|     | object |     |     |
| RequestId | string | 请求 ID。 | 20758A-585D-4A41-A9B2-28DA8F4F\\*\\*\\*\\* |
...
更多信息，参考[变更详情](https://api.aliyun.com/document/SWAS-OPEN/2020-06-01/EnableFirewallRule#workbench-doc-change-demo)。