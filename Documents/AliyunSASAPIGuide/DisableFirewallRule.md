...
[您可以在OpenAPI Explorer中直接运行该接口，免去您计算签名的困扰。运行成功后，OpenAPI Explorer可以自动生成SDK代码示例。](https://api.aliyun.com/api/SWAS-OPEN/2020-06-01/DisableFirewallRule)

 [![](https://img.alicdn.com/tfs/TB16JcyXHr1gK0jSZR0XXbP8XXa-24-26.png) 调试](https://api.aliyun.com/api/SWAS-OPEN/2020-06-01/DisableFirewallRule)
...
| --- | --- | --- | --- | --- |
| swas-open:DisableFirewallRule | update | \\*FirewallRule `acs:swas-open:{#regionId}:{#accountId}:firewallrule/{#RuleId}` | 无   | 无   |
...
| RuleId | string | 是   | 防火墙规则 ID。您可以通过调用 ListFirewallRules 接口获取防火墙规则 ID。 | eeea34d9867b4d55a4ff8d5fcfbd\\*\\*\\*\\* |
...
更多信息，参考[变更详情](https://api.aliyun.com/document/SWAS-OPEN/2020-06-01/DisableFirewallRule#workbench-doc-change-demo)。